...
ourGame = Game()
machine1 = Machine("M1",0.5,[0,0],[0,1],[1,0],[1,1])
machine2 = Machine("M2",0.5,[0,0],[0,1],[1,0],[1,1])
machine3 = Machine("M3",0.5,[0,0],[0,1],[1,0],[1,1])
machine4 = Machine("M4",0.5,[0,0],[0,1],[1,0],[1,1])
ourGame.add_machine(machine1)
ourGame.add_machine(machine2)
ourGame.add_machine(machine3)
ourGame.add_machine(machine4)
ourGame.set_foyer_line([[1.1,0,4],[1.1,0,-0.3]])
    ...
    while is_looping:
        ...
        if len(inchars)>0:
            ...
            if c1 == 'h' :
                ...
                ourGame.start_next_trial()
            elif c1 == 'z':
                ourGame.save_current_trial()
            elif c1 == 'c' :
                print_configuration(streaming_client)
            elif c1 == 's':
